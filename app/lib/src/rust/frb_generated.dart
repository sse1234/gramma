...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -139256712;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ModuleView> crateApiLibraryImportDocumentFile({
  ...
  Future<DocumentInspectionView> crateApiLibraryInspectDocumentFile({
    required String path,
  });
  ...
  String crateApiLibraryModuleCodeFromTitle({required String title});

  Future<ImageView?> crateApiTypesetModuleImage({
    required String moduleCode,
    required int index,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_String(subjectOsis, serializer);
          pdeCallFfi(
        ...
        constMeta: kCrateApiLibraryImportDocumentFileConstMeta,
        argValues: [path, kind, code, title, subjectOsis],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiLibraryImportDocumentFileConstMeta =>
      const TaskConstMeta(
        debugName: "import_document_file",
        argNames: ["path", "kind", "code", "title", "subjectOsis"],
      );
  ...
  Future<DocumentInspectionView> crateApiLibraryInspectDocumentFile({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_document_inspection_view,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiLibraryInspectDocumentFileConstMeta,
        argValues: [path],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLibraryInspectDocumentFileConstMeta =>
      const TaskConstMeta(
        debugName: "inspect_document_file",
        argNames: ["path"],
      );
  ...
  String crateApiLibraryModuleCodeFromTitle({required String title}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiLibraryModuleCodeFromTitleConstMeta,
        argValues: [title],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLibraryModuleCodeFromTitleConstMeta =>
      const TaskConstMeta(
        debugName: "module_code_from_title",
        argNames: ["title"],
      );
  ...
  Future<ImageView?> crateApiTypesetModuleImage({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_box_autoadd_image_view,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiTypesetModuleImageConstMeta,
        argValues: [moduleCode, index],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiTypesetModuleImageConstMeta => const TaskConstMeta(
    debugName: "module_image",
    argNames: ["moduleCode", "index"],
  );
  ...
  @protected
  ImageView dco_decode_box_autoadd_image_view(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_image_view(raw);
  }
  ...
  DocumentInspectionView dco_decode_document_inspection_view(dynamic raw) {
    ...
    if (arr.length != 11)
      throw Exception('unexpected arr length: expect 11 but see ${arr.length}');
    return DocumentInspectionView(
      path: dco_decode_String(arr[0]),
      title: dco_decode_String(arr[1]),
      kind: dco_decode_String(arr[2]),
      subjectBook: dco_decode_opt_String(arr[3]),
      verseNumbers: dco_decode_u_32(arr[4]),
      chapters: dco_decode_u_32(arr[5]),
      references: dco_decode_u_32(arr[6]),
      headings: dco_decode_u_32(arr[7]),
      notes: dco_decode_u_32(arr[8]),
      images: dco_decode_u_32(arr[9]),
      blocks: dco_decode_u_32(arr[10]),
    );
  }
  ...
  LineView dco_decode_line_view(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return LineView(
      runs: dco_decode_list_run_view(arr[0]),
      image: dco_decode_opt_box_autoadd_u_32(arr[1]),
      imageLines: dco_decode_u_16(arr[2]),
    );
  }
  ...
  @protected
  ImageView? dco_decode_opt_box_autoadd_image_view(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_image_view(raw);
  }
  ...
  RunView dco_decode_run_view(dynamic raw) {
    ...
    return RunView(
      ...
      style: dco_decode_u_8(arr[8]),
      scale: dco_decode_f_64(arr[9]),
      offset: dco_decode_u_32(arr[10]),
    );
  }
  ...
  @protected
  ImageView sse_decode_box_autoadd_image_view(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_image_view(deserializer));
  }
  ...
  DocumentInspectionView sse_decode_document_inspection_view(
    ...
    var var_subjectBook = sse_decode_opt_String(deserializer);
    var var_verseNumbers = sse_decode_u_32(deserializer);
    var var_chapters = sse_decode_u_32(deserializer);
    var var_references = sse_decode_u_32(deserializer);
    var var_headings = sse_decode_u_32(deserializer);
    var var_notes = sse_decode_u_32(deserializer);
    var var_images = sse_decode_u_32(deserializer);
    var var_blocks = sse_decode_u_32(deserializer);
    return DocumentInspectionView(
      path: var_path,
      title: var_title,
      kind: var_kind,
      subjectBook: var_subjectBook,
      verseNumbers: var_verseNumbers,
  ...
  LineView sse_decode_line_view(SseDeserializer deserializer) {
    ...
    var var_image = sse_decode_opt_box_autoadd_u_32(deserializer);
    var var_imageLines = sse_decode_u_16(deserializer);
    return LineView(
      runs: var_runs,
      image: var_image,
      imageLines: var_imageLines,
    );
  }
  ...
  @protected
  ImageView? sse_decode_opt_box_autoadd_image_view(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_image_view(deserializer));
    } else {
      return null;
    }
  }
  ...
  RunView sse_decode_run_view(SseDeserializer deserializer) {
    ...
    var var_style = sse_decode_u_8(deserializer);
  ...
  @protected
  void sse_encode_box_autoadd_image_view(
    ImageView self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_image_view(self, serializer);
  }
  ...
  void sse_encode_document_inspection_view(
    ...
    sse_encode_opt_String(self.subjectBook, serializer);
    sse_encode_u_32(self.verseNumbers, serializer);
    sse_encode_u_32(self.chapters, serializer);
    sse_encode_u_32(self.references, serializer);
    sse_encode_u_32(self.headings, serializer);
    sse_encode_u_32(self.notes, serializer);
    sse_encode_u_32(self.images, serializer);
  ...
  void sse_encode_line_view(LineView self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_u_32(self.image, serializer);
    sse_encode_u_16(self.imageLines, serializer);
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_image_view(
    ImageView? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_image_view(self, serializer);
    }
  }
  ...
  void sse_encode_run_view(RunView self, SseSerializer serializer) {
    ...
    sse_encode_u_8(self.style, serializer);
