...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1178573463;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        6 => wire__crate__api__library__import_osis_file_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__references__init_app_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__typeset__layout_chapter_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__references__format_reference_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__typeset__init_typesetting_impl(ptr, rust_vec_len, data_len),
        10 => wire__crate__api__user__load_layout_impl(ptr, rust_vec_len, data_len),
        ...
        16 => wire__crate__api__user__save_layout_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
